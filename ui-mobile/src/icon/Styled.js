...
export default css`
  ...
  .LdsIcon-circle:before {
    content: '\EA01';
  }
  .LdsIcon-download:before {
    content: '\EA02';
  }
  .LdsIcon-info:before {
    content: '\EA03';
  }
  .LdsIcon-safe-success:before {
    content: '\EA04';
  }
  .LdsIcon-safe-warn:before {
    content: '\EA05';
  }
  .LdsIcon-success:before {
    content: '\EA06';
  }
  .LdsIcon-success-circle:before {
    content: '\EA07';
  }
  .LdsIcon-success-no-circle:before {
    content: '\EA08';
  }
  .LdsIcon-waiting:before {
    content: '\EA09';
  }
  .LdsIcon-waiting-circle:before {
    content: '\EA0A';
  }
  .LdsIcon-warn:before {
    content: '\EA0B';
  }
  .LdsIcon-info-circle:before {
    content: '\EA0C';
  }
  .LdsIcon-cancel:before {
    content: '\EA0D';
  }
