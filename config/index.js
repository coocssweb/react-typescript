...
module.exports = {
    production: {
        devtool: false,
        NODE_ENV: 'production',
        HOST: 'https://h5.meitu.com/meituskin/h5/',
        API: 'https://h5.meitu.com/meituskin/h5/',
        jsSourceMap: false,
        cssSourceMap: false,
        eslint: false,
        filePath: 'dist/',
    ...
    test: {
        devtool: false,
        NODE_ENV: 'test',
        HOST: 'http://f2er.meitu.com/coocss/iloveyou/',
        API: 'http://f2er.meitu.com/coocss/iloveyou/',
        jsSourceMap: false,
        cssSourceMap: false,
        eslint: false,
        filePath: 'dist/',
